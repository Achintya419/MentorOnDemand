...
CREATE TABLE `training_payment` (
  ...
  KEY `FKf8gcp0rft7nf3njbs77fgranh` (`training_id`),
  CONSTRAINT `FKf8gcp0rft7nf3njbs77fgranh` FOREIGN KEY (`training_id`) REFERENCES `training` (`id`),
...
INSERT INTO `training_payment` VALUES (1,1);
